...
def testinput():
	input("now testing your microphone or other input device. after you press enter, we will go through all input devices and choose a device for you. while testing, you will hear your microphone or other device. if you don't hear it, just skip it. press enter to start")
	global samplerate
	while True:
		for d in s:
			...
			samplerate=d['default_samplerate']
			try:
				with sd.Stream(device=(d["index"], devs[0]), channels=1, callback=incallback,samplerate=samplerate):
